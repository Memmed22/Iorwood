        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    //    var _user = _unitOfWork.UserApplication.FirstOrDefault(u => u.UserName == Input.Email);
                    //    var clm = await _signInManager.CreateUserPrincipalAsync(_user);
                    //    var isSignedIn = _signInManager.IsSignedIn(clm);
                    ...
                    //};
                     ...
                     //   var jwtResult = _jwtAuthManager.GenerateTokens(Input.Email, claims, DateTime.Now);
